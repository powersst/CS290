...
<form id="userChoice"  action="rps.php" method="post" >
	<img src="images/rock.jpg" alt="Rock" style="width: 100px;" onclick="updateWins()"><br>
    <input type="radio" name="userChoice" value="Rock" title="Rock" style="margin-left: 3.25em" /><br /><br />
    <img src="images/paper.jpg" alt="Paper" style="width: 100px;" onclick="updateWins()"><br>
	<input type="radio" name="userChoice" value="Paper" title="Paper" style="margin-left: 3.25em" /><br /><br />
    <img src="images/scissors.jpg" alt="Scissors" style="width: 100px;" onclick="updateWins()"><br>
