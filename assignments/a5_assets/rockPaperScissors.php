 ...
 ?>
     ...
     <div id="gameDiv" style="display:none; margin-left: auto; margin-right: auto;">
            ...
            <h5 id="gameCount"></h5>
         	...
         	<input type="button" value="Rock" id="rock" onClick="return userRock();">
         	<input type="button" value="Paper" id="paper" onClick="return userPaper();">
        	<input type="button" value="Scissors" id="scissors" onClick="return userScissors();">
